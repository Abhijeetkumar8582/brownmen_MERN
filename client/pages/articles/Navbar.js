          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav mx-auto mb-2 mb-lg-0 justify-content-center">
              <li className="nav-item">
                <Link className="nav-link  mx-2" aria-current="page" onClick={() => onNavbarClick("Nutrition")} href="#"><b>Nutrition</b></Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link mx-2" href="#" onClick={() => onNavbarClick("Fitness")}><b>Fitness</b></Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link mx-2" href="#" onClick={() => onNavbarClick("Health")}><b>Health</b></Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link mx-2 " href="#" onClick={() => onNavbarClick("Yoga")}><b>Yoga</b></Link>
              </li>
            </ul>
