...
function Category() {
  ...
  return (
    <>
      ...
      <div className='row '>
        <div className='col'>
          <img src="https://images.pexels.com/photos/38630/bodybuilder-weight-training-stress-38630.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" style={{ width: "100%" }} height={500} alt="https://images.pe750&dpr=2" />
        </div>
        <div className='col' style={{ backgroundColor: "#408E3A" }}>
