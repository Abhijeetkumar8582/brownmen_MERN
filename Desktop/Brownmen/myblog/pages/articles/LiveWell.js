...
function Category({ response }) {
  ...
  return (
    <>
      ...
      <div className='row '>
        <div className='col'>
          <img src="https://images.pexels.com/photos/3768146/pexels-photo-3768146.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" style={{ width: "100%" }} height={500} alt="https://images.pe750&dpr=2" />
        </div>
        <div className='col' style={{ backgroundColor: "#FF9292" }}>
